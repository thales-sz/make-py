...
function Unathorized (): JSX.Element {
  const navigate = useNavigate()
  return (
    <div className="absolute -translate-x-1/2 -translate-y-1/2 top-2/4 left-1/2 text-center items-center flex flex-col">
      <h1 className='text-5xl font-extrabold uppercase'>Sem autorização!</h1>
      ...
      <h2 className='text-xl mb-4'>Está não é a página que você está procurando</h2>
