...
function Dropdown ({ handleSignOutButtonClick }: DropdownProps): JSX.Element {
  ...
  return (
    <>
      <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown" className="text-slate-50 focus:outline-none focus:ring-blue-300 rounded-lg text-center max-sm:text-base inline-flex items-center h-fit hover:underline" type="button" onClick={() => { setDropdown(!dropdown) }}>Conta<svg className="w-4 h-4 ml-2" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7" /></svg></button>
